...
Fuzzy@a:	; 2 bytes @ 0x37
	ds	2
	global	Fuzzy@a_242
Fuzzy@a_242:	; 2 bytes @ 0x39
	ds	2
	global	Fuzzy@a_243
Fuzzy@a_243:	; 2 bytes @ 0x3B
	ds	2
	global	Fuzzy@mantem
...
;; *************** function _ISR *****************
;; Defined at:
;;		line 330 in file "R:\Note\Ultimo C no MPLAB\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
i1l3187:	
;main.c: 334: {
;main.c: 335: if (USART_ReceiveChar() == '0')
...
i1l3195:	
;main.c: 341: }
;main.c: 343: if (USART_ReceiveChar() == '1')
	fcall	_USART_ReceiveChar
	xorlw	031h
	skipz
	goto	u394_21
...
i1l3201:	
;main.c: 348: }
;main.c: 350: if (USART_ReceiveChar() == '2')
	fcall	_USART_ReceiveChar
	xorlw	032h
	skipz
	goto	u395_21
...
i1l3207:	
;main.c: 355: }
;main.c: 357: if (USART_ReceiveChar() == '3')
	fcall	_USART_ReceiveChar
	xorlw	033h
	skipz
	goto	u396_21
...
i1l3213:	
;main.c: 362: }
;main.c: 364: if (USART_ReceiveChar() == '4')
	fcall	_USART_ReceiveChar
	xorlw	034h
	skipz
	goto	u397_21
...
i1l2751:	
;main.c: 169: }
;main.c: 171: deltaRpm = deltaRpm*-1;
	movlw	0x0
	movwf	(___ftmul@f1)
	movlw	0x80
	movwf	(___ftmul@f1+1)
...
i1l2755:	
;main.c: 173: }
;main.c: 175: if (deltaRpm >90) deltaRpm = 90;
	movlw	0x0
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(___ftge@ff1)
...
i1l2761:	
;main.c: 179: {
;main.c: 183: fitemp = trapmf(deltaRpm, 0,0,13,32);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(Fuzzy@deltaRpm),w
	movwf	(trapmf@x)
	...
	movwf	(_fitemp+2)^080h
	line	186
;main.c: 186: fop_rule1 = max_val(fitemp,0.1);
	movf	(_fitemp)^080h,w
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(max_val@a)
...
i1l2773:	
;main.c: 192: {
;main.c: 193: y = trapmf(x,0,0,13,32);
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	movf	(_x)^080h,w
	bcf	status, 5	;RP0=0, select bank0
...
;main.c: 205: }
;main.c: 207: }
;main.c: 213: if ((deltaRpm > 20) && (deltaRpm < 70))
	movlw	0x0
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(___ftge@ff1)
...
i1l2787:	
;main.c: 214: {
;main.c: 217: fitemp = trimf(deltaRpm, 9, 45, 81);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(Fuzzy@deltaRpm),w
	movwf	(trimf@x)
	...
	movwf	(_fitemp+2)^080h
	line	220
;main.c: 220: fop_rule2 = max_val(fitemp,0.1);
	movf	(_fitemp)^080h,w
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(max_val@a)
...
i1l2811:	
;main.c: 248: {
;main.c: 251: fitemp = trapmf(deltaRpm, 62, 79, 90, 90);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(Fuzzy@deltaRpm),w
	movwf	(trapmf@x)
	...
	movwf	(_fitemp+2)^080h
	line	255
;main.c: 255: fop_rule3 = max_val(fitemp,0.1);
	movf	(_fitemp)^080h,w
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(max_val@a)
...
i1l2823:	
;main.c: 261: {
;main.c: 262: y = trapmf(x, 62, 79, 90, 90);
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	movf	(_x)^080h,w
	bcf	status, 5	;RP0=0, select bank0
...
i1l2837:	
;main.c: 283: if (deltaRpm >= 25 && deltaRpm < 75)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(Fuzzy@deltaRpm),w
	movwf	(___ftge@ff1)
...
i1l2847:	
;main.c: 297: ativa_fan = sum/total_area;
...
i1l2849:	
;main.c: 300: ativa_fan = ativa_fan*100;
	movlw	0x0
	movwf	(___ftmul@f1)
	movlw	0xc8
	movwf	(___ftmul@f1+1)
...
;main.c: 304: if (freio = 1)
	...
	line	306
;main.c: 305: {
;main.c: 306: if ((tf + deltaV) >0 && (tf + deltaV) < 1020)
	movlw	0x0
	movwf	(___ftge@ff1)
	movlw	0x0
	movwf	(___ftge@ff1+1)
...
i1l2855:	
;main.c: 307: {
;main.c: 308: PWM_DutyCycle2(tf + deltaV);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_deltaV+1),w
	clrf	(___lwtoft@c+1)
...
i1l2857:	
;main.c: 311: {
;main.c: 312: if ((tf - deltaV) >0 && (tf - deltaV) < 1020)
	movlw	0x0
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(___ftge@ff1)
...
i1l2861:	
;main.c: 313: {
;main.c: 314: PWM_DutyCycle2(tf - deltaV);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_deltaV+1),w
	clrf	(___lwtoft@c+1)
