...
LCD_Cursor@Col:	; 1 bytes @ 0x17
	global	_isdigit$1452
_isdigit$1452:	; 1 bytes @ 0x17
...
l213:	
	line	531
;main.c: 529: {
;main.c: 531: sprintf(display_rpm,"%04d", deltaV);
...
;main.c: 541: LCD_Cursor(0,0);
	...
	fcall	_LCD_Cursor
	line	542
;main.c: 542: LCD_WriteString("DlV: ");
...
i1l2343:	
;main.c: 169: {
;main.c: 171: fitemp = trapmf(temp,-1,0,1.5,3);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_temp+1),w
	clrf	(trapmf@x+1)
	...
	line	174
;main.c: 174: fop_rule1 = max_val(fitemp,0.1);
	movf	(_fitemp+1),w
	clrf	(max_val@a+1)
	addwf	(max_val@a+1)
	movf	(_fitemp),w
...
;main.c: 178: y=0;
	...
	clrf	(_y+1)
	line	180
;main.c: 180: y = trapmf(x,-1,0,1.5,3);
	movf	(_x+1),w
	clrf	(trapmf@x+1)
	addwf	(trapmf@x+1)
	movf	(_x),w
...
i1l2359:	
;main.c: 196: {
;main.c: 198: fitemp = trimf(temp,2,5,8);
	movf	(_temp+1),w
	clrf	(trimf@x+1)
	addwf	(trimf@x+1)
	movf	(_temp),w
...
i1l2367:	
;main.c: 210: {
;main.c: 211: tip_average = fop_rule2;
	movf	(_fop_rule2+1),w
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
i1l2373:	
;main.c: 224: {
;main.c: 226: fitemp = trapmf(temp,6,8.5,10,11);
	movf	(_temp+1),w
	clrf	(trapmf@x+1)
	addwf	(trapmf@x+1)
	movf	(_temp),w
	...
	line	230
;main.c: 230: fop_rule3 = max_val(fitemp,0.1);
	movf	(_fitemp+1),w
	clrf	(max_val@a+1)
	addwf	(max_val@a+1)
	movf	(_fitemp),w
...
;main.c: 234: y=0;
	...
	clrf	(_y+1)
	line	236
;main.c: 236: y = trapmf(x,7,8.5,10,11);
	movf	(_x+1),w
	clrf	(trapmf@x+1)
	addwf	(trapmf@x+1)
	movf	(_x),w
...
i1l2381:	
;main.c: 239: {
;main.c: 240: tip_gorgeous = fop_rule3;
	movf	(_fop_rule3+1),w
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
i1l2389:	
;main.c: 254: }
;main.c: 256: if (temp >= 2.5 && temp < 7.5)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_temp+1),w
	clrf	(___lwtoft@c+1)
...
i1l2395:	
;main.c: 259: }
;main.c: 261: if (temp >= 7.5 && temp <= 10)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_temp+1),w
	clrf	(___lwtoft@c+1)
...
i1l2403:	
;main.c: 270: unsigned int sum = 0;
	clrf	(Fuzzy@sum)
	clrf	(Fuzzy@sum+1)
	line	272
	
i1l2405:	
;main.c: 272: total_area = total_area + tip ;
	movf	(_tip),w
	addwf	(_total_area),w
	movwf	(_total_area)
	movf	(_tip+1),w
...
i1l2411:	
;main.c: 282: char velocidade[1];
;main.c: 284: if(ativa_fan <= 2.5 )
	movlw	0x0
	movwf	(___ftge@ff1)
	movlw	0x20
	movwf	(___ftge@ff1+1)
...
i1l2415:	
;main.c: 288: }
;main.c: 289: if(ativa_fan > 2.5 && ativa_fan < 7.5)
	movlw	0x0
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(___ftge@ff1)
